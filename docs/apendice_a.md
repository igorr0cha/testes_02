...
**2. Arquivo do Desenvolvedor (`src/agendamento.py`)**
...
**3. Arquivo do QA (`tests/test_agendamento.py`)**
...
*Saída registrada em ambiente Windows:*
```
============================= test session starts =============================
...
tests/test_agendamento.py::test_validacao_antecedencia[test_menos_24h] PASSED  [ 20%]
tests/test_agendamento.py::test_validacao_antecedencia[test_24h] PASSED        [ 40%]
tests/test_agendamento.py::test_validacao_antecedencia[test_entre] PASSED      [ 60%]
tests/test_agendamento.py::test_validacao_antecedencia[test_90_dias] PASSED    [ 80%]
tests/test_agendamento.py::test_validacao_antecedencia[test_mais_90_dias] PASSED [100%]
